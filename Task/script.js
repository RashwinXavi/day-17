...
for(var i=0;i<data1.length;i++)
{
  row.innerHTML+=`<div class="col-md-4">
   <div class="card">
      <h4 class="card-header bg-dark"  text-align:center">${data1[i].name}</h4>
      <img style="padding:10px; display:block; margin-left: auto; margin-right: auto; width: 80%;" src="${data1[i].flag}" class="card-img-top" alt="...">
        <div class="card-body">
